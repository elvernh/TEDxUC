      ...
      <div class="footer-content">
        ...
        <div class="footer-column">
          ...
          <div class="footer-social">
            <a
              href="https://www.instagram.com/tedxuniversitasciputrasurabaya"
              target="_blank"
              class="social-icon"
            >
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/tedxuniversitasciputrasurabaya"
              target="_blank"
              class="social-icon"
            >
              <svg
              ...
              >
                <path
                  d="M4.98 3.5c0 1.38-1.12 2.5-2.5 2.5s-2.5-1.12-2.5-2.5S1.1 1 2.48 1s2.5 1.12 2.5 2.5zM.5 8.5h4v12h-4zm7.5 0h4v1.85h.06c.56-1.06 1.93-2.18 3.94-2.18 4.2 0 4.97 2.76 4.97 6.35v7.98h-4v-7.08c0-1.69-.03-3.87-2.36-3.87-2.37 0-2.73 1.84-2.73 3.74v7.21h-4z"
                />
              </svg>
            </a>
            <a
              href="mailto:tedxuniversitasciputrasurabaya@gmail.com"
              target="_blank"
              class="social-icon"
            >
              <svg
              ...
              >
                <path
                  d="M12 12.713l11.998-7.692v12.98c0 1.017-.842 1.999-1.889 1.999H1.889C.841 19.999 0 19.018 0 18V5.021l11.999 7.692zm0-2.713L1.013 3h21.974L12 10z"
                />
              </svg>
            </a>
          </div>
